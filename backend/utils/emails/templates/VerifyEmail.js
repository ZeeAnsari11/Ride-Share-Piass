const verifyEmail = (code) => {
    ...
    <body>
        ...
        <br />
        <h1 class="text-theme text-center mb-5" style="color: #fd7e14; text-align: center; margin-bottom: 50px;"> 
        Welcome to Start Up
        </h1>
        <section class="text-center bg-theme" style="color: white; padding: 50px; background-color: rgb(4,44,0); text-align: center;">
            ...
            <button style="border: none; width: 200px; height: 40px; border-radius: 5px; margin: 10px;" class="code"> 
            ${code} 
            </button>
        </section>
    </body>
